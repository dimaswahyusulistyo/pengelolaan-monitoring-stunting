<template>
  <VRow>
    <VCol cols="12">
      <VCard title="DATA REGULASI" class="rounded-lg">
              ...
              <tr v-for="(regulasi, index) in regulasis" :key="regulasi.id_regulasi">
                ...
                <td>
                  <div class="button-group">
                    <VBtn icon color="warning" @click="editRegulasi(regulasi)" class="square-button">
                      <i class="bx bxs-edit-alt"></i>
                    </VBtn>
                    <!-- <VBtn icon color="success" @click="viewDetail(activity)" class="square-button">
                      <i class="bx bxs-info-circle"></i>
                    </VBtn> -->
                    <VBtn icon color="error" @click="deleteRegulasi(regulasi)" class="square-button">
